...
public class ScreenshotManagementScreen
    ...
    private void saveFinal() {
        ...
        if (isSuccessful) {
            ...
            sendMessage(translated("snap.screen.save.success").formatted(GREEN).append(openFileClickableText));
        } else {
    ...
    private void copyToClipboard() {
        ...
        if (success) sendMessage(translated("snap.screen.copy.success").formatted(GREEN));
